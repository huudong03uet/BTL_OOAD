...
export default function EditAuction() {
    ...
    return (
        <div className='row mx-5'>
            ...
            <div>
                <button type="submit" className="btn btn-dark mb-4 col-2" >Change Auction</button>
                <button type="submit" className="btn btn-light ms-3 mb-4 col-2" onClick={() => { window.location.href = '/seller/my-auction'}}>Cancel Change</button>
            </div>
