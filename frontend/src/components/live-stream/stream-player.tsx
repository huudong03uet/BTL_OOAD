...
export default function StreamPlayerWrapper({ streamerIdentity }: Props) {
  ...
  if (connectionState !== ConnectionState.Connected || !participant) {
    return (
      <div className="h-100 align-items-center justify-content-center d-flex bg-black">
        <div className="aspect-video  text-sm uppercase text-white bg-black">
...
export const StreamPlayer = ({ participant }: { participant: Participant }) => {
  ...
  return (
    <TooltipProvider delayDuration={300}>
      <div className="relative d-flex aspect-video bg-black h-100 justify-content-center align-items-center overflow-auto" ref={playerEl}>
        <video ref={videoEl} height="100%" />
