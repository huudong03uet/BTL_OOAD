...
const check_user_love_product = async (product_id: number) => {
    try {
        let url = `${HOST}/love-product/user_id=${UserDataService.getUserData()?.user_id}/product_id=${product_id}`;
...
const user_delete_love_product = async (product_id: number) => {
    try {
        let url = `${HOST}/love-product/delete/user_id=${UserDataService.getUserData()?.user_id}/product_id=${product_id}`;
