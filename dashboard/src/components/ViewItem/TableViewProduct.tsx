...
const TableProduct: React.FC<TableProductProps> = ({ packageData }) => {
    ...
    const handleSearchIdChange = (event: React.ChangeEvent<HTMLInputElement>) => {
        ...
        //call api search product với searchId và searchStatus
    ...
    return (
        <div className="rounded-sm border border-stroke bg-white px-5 pb-2.5 pt-6 shadow-default dark:border-strokedark dark:bg-boxdark sm:px-7.5 xl:pb-1">
            ...
            />
                ...
                <p className="pl-2 text-black dark:text-white">Status</p>
                    <select className="bg-transparent pl-2" value={status} onChange={handleStatusChange}>
                            ...
                            <tr key={key}>
                                ...
                                <td className="border-b border-[#eee] px-4 py-5 dark:border-strokedark">
                                    <div className="flex items-center space-x-3.5">
                                        ...
                                        <button className="hover:text-primary" onClick={() => { handleDeleteProduct(packageItem) }}>
                                            <svg
                                                className="fill-current"
                                                width="18"
                                                height="18"
