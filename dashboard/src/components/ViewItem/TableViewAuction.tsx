'use client'
import DeleteModal from "@/components/Modal/ModalDeleteAuction";
...
const TableAuction: React.FC<TableAuctionProps> = ({ packageData, onUpdateAuction }) => {
    ...
    const handleSearchIdChange = (event: React.ChangeEvent<HTMLInputElement>) => {
        ...
        //call api search Auction với searchId và searchStatus
                            ...
                            <tr key={key}>
                                ...
                                <td className="border-b border-[#eee] px-4 py-5 dark:border-strokedark">
                                    <div className="flex items-center space-x-3.5">
                                        <button className="hover:text-primary" onClick={() => { handleViewAuction(packageItem) }}>
                                            <svg
                                        ...
                                        <button className="hover:text-primary" onClick={() => { handleDeleteAuction(packageItem) }}>
                                            <svg
                                                className="fill-current"
                                                width="18"
                                                height="18"
